        ...
        <div className="w-full max-w-xl rounded-2xl bg-white shadow-2xl border border-slate-200 p-6 relative">
          ...
          <form onSubmit={handleUpload} className='space-y-5'>
            <div className='space-y-2'>
              ...
              <input 
                type="text" 
                className='w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-slate-900 placeholder:text-slate-400 shadow-sm focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/30' 
            ...
            <div className='space-y-2'>
              ...
              <div
                className={`rounded-xl border-2 border-dashed p-6 text-center transition ${dragActive ? 'border-violet-400 bg-violet-50/50' : 'border-slate-200 bg-slate-50'}`}
              ...
              >
                <div className="flex flex-col items-center gap-2 text-slate-600">
                  ...
                  <label className="inline-flex items-center gap-2 rounded-lg bg-violet-500 px-3 py-2 text-sm font-semibold text-white shadow hover:bg-violet-400 cursor-pointer">
