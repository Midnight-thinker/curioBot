...
const DashboardPage = () => {
  ...
  const stats = [
    ...
    { label: "Total Flashcards", value: dashboardData.overview.totalFlashcards, icon: BookOpen, gradient: "from-violet-500 to-teal-600" },
              ...
              return (
                <li key={activity.id} className="px-4 py-3">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-full ${isDoc ? 'bg-blue-50 text-blue-600' : 'bg-violet-50 text-violet-600'}`}>
