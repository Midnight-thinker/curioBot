    ...
    return (
        <div className="relative w-full h-72 flex items-center justify-center" style={{ perspective: '1200px' }}>
            ...
            >
                {/* front */}
                <div
                    className="absolute inset-0 rounded-2xl border border-violet-100/80 bg-gradient-to-br from-white via-violet-50 to-white p-5 shadow-md"
                    style={{ backfaceVisibility: 'hidden', WebkitBackfaceVisibility: 'hidden' }}
                >
                    <div className="flex items-start justify-between gap-3">
                        <div className="inline-flex items-center gap-2 rounded-full bg-violet-100/80 px-3 py-1 text-xs font-semibold text-violet-800">
                    ...
                    <div className="absolute inset-x-5 bottom-4 flex items-center justify-end text-xs font-semibold text-violet-700">
                ...
                {/* back */}
                <div
                    className="absolute inset-0 rotateY-180 rounded-2xl border border-violet-100/80 bg-gradient-to-br from-violet-600 via-violet-500 to-violet-600 p-5 text-white shadow-md"
