...
const FlashcardSetCard = ({ flashcardSet }) => {
    ...
    return (
        ...
        >
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-violet-500 via-teal-500 to-cyan-500" />

            {/* Header */}
            <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-violet-50 text-violet-700 ring-1 ring-violet-100">
                        <BookOpen className="h-6 w-6" />
                    </div>
                    <div className="flex flex-col gap-1 min-w-0">
                        <p className="text-xs font-semibold uppercase tracking-wide text-violet-700 inline-flex items-center gap-2">
            ...
            <div className="mt-4 space-y-2">
                ...
                <div className="relative h-3 overflow-hidden rounded-full bg-slate-100">
                    <div
                        className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-violet-500 via-teal-500 to-cyan-500 transition-all"
