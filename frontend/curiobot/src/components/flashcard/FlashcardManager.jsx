      ...
      return (
        <div className="p-8 flex flex-col items-center text-center gap-3 rounded-2xl border border-slate-200 bg-slate-50/70">
          ...
          <button
            ...
            disabled={generating}
            className="mt-2 inline-flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-white text-sm font-semibold shadow hover:bg-violet-700 disabled:opacity-50"
          >
            {generating ? (
        ...
        <div className="mb-4 flex items-center justify-between gap-3">
          ...
          <div className='p-4'>
            <button
              onClick={handleGnerateFlashcards}
              disabled={generating}
              className=" inline-flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-white text-sm font-semibold shadow hover:bg-violet-700 disabled:opacity-50"
            >
              {generating ? (
                <><Spinner size="sm" /> Generating...</>
              ) : (
        ...
        <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3 px-4 mb-4">
          {flashcardSets.map((set) => (
            <div
              ...
              className="group cursor-pointer rounded-3xl border border-violet-100/70 bg-gradient-to-br from-violet-50 via-white to-slate-50 p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-violet-600 text-violet-50 shadow-sm">
              ...
              <div className="mt-4 flex items-center justify-between text-sm">
                <span className="inline-flex items-center gap-2 rounded-full bg-violet-100/70 px-3 py-1 text-violet-700">
