                ...
                <div className="p-6 grid gap-6 md:grid-cols-2">
                    ...
                    <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className="inline-flex items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-white text-sm font-semibold shadow hover:bg-violet-700 disabled:opacity-50"
                        >
                    ...
                    <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-4 flex flex-col gap-3">
                        ...
                        <form onSubmit={handleExplainConcept} className="flex flex-col gap-3">
                            <input
                                ...
                                className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500 disabled:opacity-50"
                            />
                            <button
                                type="submit"
                                disabled={loadingAction === 'explain'}
